...
public class MetaModelContextImpl implements MetaModelContext {
    ...
    private GlobalConfigFactory globalConfigFactory;

    private Logger logger = LoggerFactory.getLogger(MetaModelContextImpl.class);

    public MetaModelContextImpl(GlobalConfigFactory globalConfigFactory, EntityResolver entityResolver) {
    ...
    private void registerMetaModels() {
        GlobalConfig globalConfig = globalConfigFactory.getGlobalConfig();
    ...
    public GlobalConfig getGlobalConfig() {
        return globalConfigFactory.getGlobalConfig();
    }

    @Override
    public void refresh() {
        processedMetaModelClasses.clear();
        resolvedTableInfos.clear();
        tableMapping.clear();
        globalConfigFactory.refresh();
        init();
    }
